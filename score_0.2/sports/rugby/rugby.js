...
async function getGameData() {
    const dataUrl = `https://sports-api.named.com/v1.0/sports/football/games?date=${requestDate}&status=ALL`;
                ...
                <div class="field-cover">
                    <div class="circle-wrap">
                        <img src="${game.result === 'WIN' 
                                ? `./../../assets/images/volleyball/detail/${game.teams.home.imgPath.split('/')[4]}` 
                                : `./../../assets/images/volleyball/detail/${game.teams.away.imgPath.split('/')[4]}`}"
                        alt="Team Logo">
                    </div>
                </div>
...
function createTableRow(game) {
    ...
    gameRow.innerHTML = `
        ...
        <div class="team-info">
            ...
            <div class="tr">
                <div class="td">
                    <img width="55" height="55" src="./../../assets/images/volleyball/detail/${game.teams.away.imgPath.split('/')[4]}">
                </div>
            ...
            <div class="tr">
                <div class="td">
                    <img width="55" height="55"  src="./../../assets/images/volleyball/detail/${game.teams.home.imgPath.split('/')[4]}">
                </div>
            ...
            <div class="tr th ${getStatusClass(game.gameStatus)}">
                ${
                    ...
                    ? Array.from({length: 5}, (_, index) => {
                        ...
                        if (index >= 4) { // 5번째 데이터가 없을 경우 "연장" 출력
